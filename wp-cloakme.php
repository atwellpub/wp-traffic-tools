...
function wptt_cloakme_settings()
{
	...
	<div class='wptt_featurebox'>
		...
		<hr>
		<div style='text-align:left; vertical-align:top; width:40%;display:inline-block;padding-right:20px;'>
			<h5>Description</h5>
			How to set a default query to the end of a masked link/final destination URL. What this feature will do is look to see if a param is inlcuded (such as ?a=1) and if it is not then it will automatically add the default for 'a' as set in the PHP constant.
		</div>
		<div style='text-align:left; vertical-align:top; width:50%; padding-left:20px;display:inline-block;'>						
			<h5>Instructions</h5>
			<p>Open your themes functions.php file and add the following constant</p>
			
			<i>define('WPTT_CLOAKED_LINK_DEFAULT_PARAM', 'a=default' );</i>
			<br>
			or 
			<br>
			<i>define('WPTT_CLOAKED_LINK_DEFAULT_PARAM', 'a=default&b=default2' );</i>
...
{		
	...
	if ($_POST['nature']=='cloaking_save_profile')
	{
		...
		$rotate_urls_count = (isset($_POST['rotate_urls_count'])) ? $_POST['rotate_urls_count'] : '1';
